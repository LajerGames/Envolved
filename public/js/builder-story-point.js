...
$(document).ready(function () {
    ...
    */
    ...
    $('div.panel-body').on('change', '.story-point-text-interlocutor-name', function () {
        ...
        thisFormContainer = $(this).closest('.story-point-form-container'), destinationDatalist = thisFormContainer.find('datalist'), selectedIDInput = thisFormContainer.find('.story-point-text-interlocutor-id');
