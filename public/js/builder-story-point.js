...
$(document).ready(function () {
    ...
    */
    ...
    var addLeadsToToStoryPoint = function addLeadsToToStoryPoint(storyPointID, ref, type, action) {
    ...
    $('div.panel-body').on('change', '.story-point-interlocutor-name', function () {
        ...
        thisFormContainer = $(this).closest('.story-point-form-container'), destinationDatalist = thisFormContainer.find('datalist'), selectedIDInput = thisFormContainer.find('.story-point-interlocutor-id');
        ...
        destinationDatalist.find('option').each(function () {
            ...
            if ($(this).val() == selectedDestination.val()) {
                ...
                $.post('/get-character-and-storypoint-settings', {
                    _token: $('meta[name=csrf-token]').attr('content'),
                    _method: 'POST',
                    data: {
                        story_point_id: storyPointID,
